module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const message =
  "⚽ Где смотреть матч Норвегия — Франция?\n\n" +
  "26 июня в 22:00 приглашаем всех любителей футбола в наш кинозал на Северной, 299А 🖤\n\n" +
  "Большой экран, компания настоящих болельщиков, кальяны, напитки и атмосфера, в которой каждый опасный момент ощущается совсем по-другому.\n\n" +
  "Если не хочешь смотреть матч дома — собирай друзей и бронируй столик заранее.\n\n" +
  "📍 Северная, 299А";
    const result = {
      ok: true,
