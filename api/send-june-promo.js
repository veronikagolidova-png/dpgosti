module.exports = async function handler(req, res) {
  ...
  try {
   ...
   const message =
"🍦 Готов пьянеть от мороженого?\n\n" +
"Тогда у нас для тебя две новости.\n\n" +
"Сегодня в «Давай Покрепче» проходит открытая смена с амбассадором SEBERO — новые вкусы, необычные миксы и возможность попробовать то, чего ещё не было.\n\n" +
"А ещё сегодня каждого гостя угощаем алкогольным мороженым. Да-да, оно действительно с градусом. 😏\n\n" +
"📍 40 Лет Победы, 148/2";
    const result = {
      ok: true,
