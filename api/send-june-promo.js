module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const message =
  "Ты готов гулять с нами до утра? 🌙\n\n" +
  "Хорошие новости: в эту пятницу и субботу «Давай Покрепче» на Северной 299А работает до 04:00 🔥\n\n" +
  "Так что можно не смотреть на часы, а просто отдыхать, общаться, курить кальян и наслаждаться вечером.\n\n" +
  "На сколько человек бронировать столик? 😉";
    const result = {
      ok: true,
