...
const message = `Слышишь? Это звон бокалов на нашем винном безлимите 🍷

Сегодня весь вечер пьём грузинское вино без ограничений за 1 500 ₽.

Не забудь заехать в «Давай Покрепче» на 40 Лет Победы, 148/2 🖤`;
  try {
