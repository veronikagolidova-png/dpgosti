...
const message = `Осталось всего 3 матча — и Чемпионат мира 2026 закончится ⚽️

Впереди два полуфинала и главный финал.

И все три матча мы смотрим вместе в нашем кинозале на Северной, 299А:
...
Собирай друзей, бронируй стол и приходи болеть за любимую команду 🫶🏻`;
  try {
