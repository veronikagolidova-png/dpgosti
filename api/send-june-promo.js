...
const message = `Сегодня официально можно немного выдохнуть 🍷

Потому что четверг в «Давай Покрепче» = винный безлимит.

Собирай друзей и приезжай на 40 Лет Победы, 148/2.

1 500 ₽ — и грузинское вино без ограничений 🖤

Кажется, план на вечер уже есть.`;
  try {
