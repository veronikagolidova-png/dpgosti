...
const message = `Привет) Не строй планы на 8 августа. Мы тебя забираем 🖤

«Давай Покрепче» на 40 Лет Победы, 148/2 празднует день рождения!

Нам очень хочется, чтобы в субботу ты был рядом с нами.

Мы подготовили настоящий праздник:

🥃 Прокур всех линеек табака «Наш» вместе с амбассадором — с 13:30 до 16:30

🕵️ Авторская игра-расследование «Найди кодовое слово»

🍸 Welcome-коктейли

📸 Вечером — фотограф

🎁 И весь день — розыгрыши подарков от нас и наших партнёров

Очень надеемся разделить этот день именно с тобой.

Нажимай кнопку «Забронировать стол» внизу и приходи вместе с друзьями 🖤`;
  try {
