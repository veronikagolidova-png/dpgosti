...
const message = `Ну что, кто готов доказать, что думает на пару ходов вперёд? 👀♟️

Мы собираем участников на турнир по шахматам и нардам в «Давай Покрепче».

И если ты хотел поучаствовать, то сегодня последний день, чтобы подать заявку 🔥

Неважно, что выбираешь — шахматы или нарды. Главное — желание сыграть и побороться за победу.

Переходи в нашего бота и оставляй заявку. Сегодня последний шанс попасть в список участников 🖤`;
  try {
