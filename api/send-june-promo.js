...
const message = `Всё. Рабочая неделя официально закончилась. Выдыхаем 😮‍💨

Пятница — отличный повод собрать своих и наконец никуда не спешить.

Кальяны, коктейли, любимые люди рядом — всё остальное подождёт 🖤

Ждём тебя сегодня в «Давай Покрепче»`;
  try {
