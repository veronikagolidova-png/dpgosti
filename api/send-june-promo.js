...
const message = `У нас для тебя небольшое объявление 🖤

20 июля, в понедельник, «Давай Покрепче» не работает — ни на Северной, 299А, ни на 40 Лет Победы, 148/2.

Но уже 21 июля, со вторника, с 16:00 обе точки снова открыты и ждут тебя 😉

Приносим извинения за небольшую паузу и до встречи во вторник 🖤`;
  try {
