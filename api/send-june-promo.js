module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const message =
      "🔥 Афиша июня уже в боте\n\n" +
      "Мы добавили все мероприятия на этот месяц, и некоторые даты могут быстро заняться.\n\n" +
      "Что тебя ждет:\n\n" +
      "🍓 День клубники\n" +
      "🎉 Тематические вечера\n" +
      "🦆 Большая охота на уточек с призом 5000 ₽\n" +
      "и еще несколько сюрпризов 😉\n\n" +
      "Заглядывай в раздел «Афиша мероприятий» и выбирай дату для встречи с друзьями.\n\n" +
      "Столики на популярные дни лучше бронировать заранее 👇";
